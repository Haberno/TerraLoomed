...
public class RTFPlacementModifiers {
    ...
    @SafeVarargs
	public static DimensionFilter dimensionFilter(RegistryKey<DimensionOptions>... levels) {
    ...
    public static NoiseFilter noiseFilter(RegistryEntry<Noise> noise, float threshold) {
    ...
    private static <P extends PlacementModifier> PlacementModifierType<P> register(String name, Codec<P> codec) {
		...
		RegistryUtil.register(Registries.PLACEMENT_MODIFIER_TYPE, name, type);
		return type;
    }
}
