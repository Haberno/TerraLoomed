...
public class Noises {
	...
	public record HolderHolder(RegistryEntry<Noise> holder) implements Noise {
		...
		public float minValue() {
			return this.holder.hasKeyAndValue() ? this.holder.value().minValue() : Float.NEGATIVE_INFINITY;
		}

		@Override
		public float maxValue() {
			return this.holder.hasKeyAndValue() ? this.holder.value().maxValue() : Float.POSITIVE_INFINITY;
		}

		@Override
		public Noise mapAll(Visitor visitor) {
			return visitor.apply(new HolderHolder(RegistryEntry.of(this.holder.value().mapAll(visitor))));
		}
