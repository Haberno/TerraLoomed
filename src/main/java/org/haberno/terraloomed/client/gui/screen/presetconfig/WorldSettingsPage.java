...
public class WorldSettingsPage extends PresetEditorPage {
	...
	private CyclingButtonWidget<DistanceFunction> continentShape;
	...
	private CyclingButtonWidget<SpawnType> spawnType;
	...
	@Override
	public Text title() {
		return Text.translatable(RTFTranslationKeys.GUI_WORLD_SETTINGS_TITLE);
	}
