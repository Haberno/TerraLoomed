...
public class MiscellaneousPage extends PresetEditorPage {
	private CyclingButtonWidget<Boolean> smoothLayerDecorator;
	private Slider strataRegionSize;
	private CyclingButtonWidget<Boolean> strataDecorator;
	private CyclingButtonWidget<Boolean> oreCompatibleStoneOnly;
	private CyclingButtonWidget<Boolean> erosionDecorator;
	private CyclingButtonWidget<Boolean> plainStoneErosion;
	private CyclingButtonWidget<Boolean> naturalSnowDecorator;
	private CyclingButtonWidget<Boolean> customBiomeFeatures;
	private CyclingButtonWidget<Boolean> vanillaSprings;
	private CyclingButtonWidget<Boolean> vanillaLavaLakes;
	private CyclingButtonWidget<Boolean> vanillaLavaSprings;
	...
	@Override
	public Text title() {
		return Text.translatable(RTFTranslationKeys.GUI_MISCELLANEOUS_SETTINGS_TITLE);
	}
