...
public class PresetSurfaceNoise {
	...
	public static final RegistryKey<Noise> HEIGHT_VARIANCE = createKey("height_variance");
	public static final RegistryKey<Noise> STEEPNESS_VARIANCE = createKey("steepness_variance");

	public static final RegistryKey<Noise> ERODED_DIRT = createKey("eroded_dirt");
	public static final RegistryKey<Noise> ERODED_ROCK = createKey("eroded_rock");
	
	public static final RegistryKey<Noise> DESERT = createKey("desert");
	public static final RegistryKey<Noise> SWAMP = createKey("swamp");
	public static final RegistryKey<Noise> FOREST = createKey("forest");
	public static final RegistryKey<Noise> RIVER_BANK = createKey("river_bank");
		
	public static final RegistryKey<Noise> ICEBERG_DEEP_SHAPE = createKey("iceberg/deep/shape");
	public static final RegistryKey<Noise> ICEBERG_DEEP_MASK = createKey("iceberg/deep/mask");
	public static final RegistryKey<Noise> ICEBERG_DEEP_FADE_DOWN = createKey("iceberg/deep/fade_down");
	public static final RegistryKey<Noise> ICEBERG_DEEP_FADE_UP = createKey("iceberg/deep/fade_up");
	public static final RegistryKey<Noise> ICEBERG_DEEP_UP = createKey("iceberg/deep/up");
	public static final RegistryKey<Noise> ICEBERG_DEEP_DOWN = createKey("iceberg/deep/down");
	public static final RegistryKey<Noise> ICEBERG_DEEP_TOP = createKey("iceberg/deep/top");

	public static final RegistryKey<Noise> ICEBERG_SHALLOW_SHAPE = createKey("iceberg/shallow/shape");
	public static final RegistryKey<Noise> ICEBERG_SHALLOW_MASK = createKey("iceberg/shallow/mask");
	public static final RegistryKey<Noise> ICEBERG_SHALLOW_FADE_DOWN = createKey("iceberg/shallow/fade_down");
	public static final RegistryKey<Noise> ICEBERG_SHALLOW_FADE_UP = createKey("iceberg/shallow/fade_up");
	public static final RegistryKey<Noise> ICEBERG_SHALLOW_UP = createKey("iceberg/shallow/up");
	public static final RegistryKey<Noise> ICEBERG_SHALLOW_DOWN = createKey("iceberg/shallow/down");
	public static final RegistryKey<Noise> ICEBERG_SHALLOW_TOP = createKey("iceberg/shallow/top");

	public static final RegistryKey<Noise> STRATA_REGION = createKey("strata/region");
	public static final RegistryKey<Noise> STRATA_DEPTH = createKey("strata/depth");
	...
	private static void registerIceberg(Registerable<Noise> ctx, RegistryKey<Noise> shapeKey, RegistryKey<Noise> maskKey, RegistryKey<Noise> fadeDownKey, RegistryKey<Noise> fadeUpKey, RegistryKey<Noise> upKey, RegistryKey<Noise> downKey, RegistryKey<Noise> topKey, Scaling scaling, int height, int depth, int seedOffset) {
